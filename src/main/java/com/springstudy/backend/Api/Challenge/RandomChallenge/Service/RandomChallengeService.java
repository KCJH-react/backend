package com.springstudy.backend.Api.Challenge.RandomChallenge.Service;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.springstudy.backend.Api.Auth.Service.AuthService;
import com.springstudy.backend.Api.Challenge.PersonalChallenge.Model.Response.ChallengeResponse;
import com.springstudy.backend.Api.Challenge.RandomChallenge.Model.Request.ChatGPTRequestDTO;
import com.springstudy.backend.Api.Challenge.RandomChallenge.Model.Response.ChatGPTResponseDTO;
...
@Service
public class RandomChallengeService {
    ...
    public RandomChallengeService(ChallengeRepository challengeRepository, UserCategoryRepository userCategoryRepository, UserRepository userRepository, User_UserCategoryRepository userUserCategoryRepository, AuthService authService) {
    ...
    //Response 타입으로 만들기
    public ResponseEntity<Response<RandomChallengeResponse>> makeChallengeResult(String systemPrompt, String userPrompt, Long userId) {
        try {
            ChallengeResponse challengeResponse = makeChallengeGPT(systemPrompt, userPrompt).block();
            Optional<User> userOptional = userRepository.findById(userId);
            if(userOptional.isEmpty()) {
                return ResponseBuilder.<RandomChallengeResponse>create()
            ...
            RandomChallengeResponse combinedResponse = RandomChallengeResponse.builder()
                    // Challenge 정보
    ...
    public ResponseEntity<Response<RandomChallengeResponse>> checkAndMakeChallengeResult(String systemPrompt, String userPrompt, Long userId) {
        try {
