...
//    @PostMapping("/send")
//    public ResponseEntity<Response<RequestEmail>> sendEmail(@RequestBody @Valid EmailRequest emailRequest) {
//        return emailService.sendMail(emailRequest);
//    }
//    @PostMapping("/check")
//    public ResponseEntity<Response<ResponseEmail>> checkEmail(@RequestBody @Valid EmailVerifyRequest emailRequest) {
